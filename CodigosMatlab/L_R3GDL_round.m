...
T01=simplify([cos(theta1) -round(cos(alpha1),9)*sin(theta1) round(sin(alpha1),9)*sin(theta1) a1*cos(theta1);
    sin(theta1)  round(cos(alpha1),9)*cos(theta1)  -round(sin(alpha1),9)*cos(theta1) a1*sin(theta1);
    0            round(sin(alpha1),9)              round(cos(alpha1),9)              d1            ;
    0                  0                     0                      1            ]);

T12=simplify([cos(theta2) -round(cos(alpha2),9)*sin(theta2) round(sin(alpha2),9)*sin(theta2) a2*cos(theta2);
    sin(theta2)  round(cos(alpha2),9)*cos(theta2)  -round(sin(alpha2),9)*cos(theta2) a2*sin(theta2);
    0            round(sin(alpha2),9)              round(cos(alpha2),9)              d2            ;
    0                  0                     0                      1            ]);

T23=simplify([cos(theta3) -round(cos(alpha3),9)*sin(theta3) round(sin(alpha3),9)*sin(theta3) a3*cos(theta3);
    sin(theta3)  round(cos(alpha3),9)*cos(theta3)  -round(sin(alpha3),9)*cos(theta3) a3*sin(theta3);
    0            round(sin(alpha3),9)              round(cos(alpha3),9)              d3            ;
    0                  0                     0                      1            ]);
T34=simplify([cos(theta4) -round(cos(alpha4),9)*sin(theta4) round(sin(alpha4),9)*sin(theta4) a4*cos(theta4);
    sin(theta4)  round(cos(alpha4),9)*cos(theta4)  -round(sin(alpha4),9)*cos(theta4) a4*sin(theta4);
    0            round(sin(alpha4),9)              round(cos(alpha4),9)              d4            ;
    0                  0                     0                      1            ]);
T45=simplify([cos(theta5) -round(cos(alpha5),9)*sin(theta5) round(sin(alpha5),9)*sin(theta5) a5*cos(theta5);
    sin(theta5)  round(cos(alpha5),9)*cos(theta5)  -round(sin(alpha5),9)*cos(theta5) a5*sin(theta5);
    0            round(sin(alpha5),9)              round(cos(alpha5),9)              d5            ;
    0                  0                     0                      1            ]);
T56=simplify([cos(theta6) -round(cos(alpha6),9)*sin(theta6) round(sin(alpha6),9)*sin(theta6) a6*cos(theta6);
    sin(theta6)  round(cos(alpha6),9)*cos(theta6)  -round(sin(alpha6),9)*cos(theta6) a6*sin(theta6);
    0            round(sin(alpha6),9)              round(cos(alpha6),9)              d6            ;
    0                  0                     0                      1            ]);
...
dLdq1 = diff(L,qd1);
dLdq1dt = diff(dLdq1,q1)*qd1+diff(dLdq1,q2)*qd2+diff(dLdq1,q3)*qd3+diff(dLdq1,qd1)*qdd1+diff(dLdq1,qd2)*qdd2+diff(dLdq1,qd3)*qdd3+diff(dLdq1,q4)*qd4+diff(dLdq1,q5)*qd5+diff(dLdq1,q6)*qd6+diff(dLdq1,qd4)*qdd4+diff(dLdq1,qd5)*qdd5+diff(dLdq1,qd6)*qdd6;
dLdq1 = diff(L,q1);
T1 = dLdq1dt - dLdq1;

% Ecuación 2: T2 = d/dt(dL/qd2) - dL/q2
dLdq2 = diff(L,qd2);
dLdq2dt = diff(dLdq2,q1)*qd1+diff(dLdq2,q2)*qd2+diff(dLdq2,q3)*qd3+diff(dLdq2,qd1)*qdd1+diff(dLdq2,qd2)*qdd2+diff(dLdq2,qd3)*qdd3+diff(dLdq2,q4)*qd4+diff(dLdq2,q5)*qd5+diff(dLdq2,q6)*qd6+diff(dLdq2,qd4)*qdd4+diff(dLdq2,qd5)*qdd5+diff(dLdq2,qd6)*qdd6;
dLdq2 = diff(L,q2);
T2 = dLdq2dt - dLdq2;

% Ecuación3: T3 = d/dt(dL/qd3) - dL/q3
dLdq3 = diff(L,qd3);
dLdq3dt = diff(dLdq3,q1)*qd1+diff(dLdq3,q2)*qd2+diff(dLdq3,q3)*qd3+diff(dLdq3,qd1)*qdd1+diff(dLdq3,qd2)*qdd2+diff(dLdq3,qd3)*qdd3+diff(dLdq3,q4)*qd4+diff(dLdq3,q5)*qd5+diff(dLdq3,q6)*qd6+diff(dLdq3,qd4)*qdd4+diff(dLdq3,qd5)*qdd5+diff(dLdq3,qd6)*qdd6;
dLdq3 = diff(L,q3);
T3 = dLdq3dt - dLdq3;

% Ecuación4: T4 = d/dt(dL/qd4) - dL/q4
dLdq4 = diff(L,qd4);
dLdq4dt = diff(dLdq4,q1)*qd1+diff(dLdq4,q2)*qd2+diff(dLdq4,q3)*qd3+diff(dLdq4,qd1)*qdd1+diff(dLdq4,qd2)*qdd2+diff(dLdq4,qd3)*qdd3+diff(dLdq4,q4)*qd4+diff(dLdq4,q5)*qd5+diff(dLdq4,q6)*qd6+diff(dLdq4,qd4)*qdd4+diff(dLdq4,qd5)*qdd5+diff(dLdq4,qd6)*qdd6;
dLdq4 = diff(L,q4);
T4 = dLdq4dt - dLdq4;

% Ecuación4: T5 = d/dt(dL/qd5) - dL/q5
dLdq5 = diff(L,qd5);
dLdq5dt = diff(dLdq5,q1)*qd1+diff(dLdq5,q2)*qd2+diff(dLdq5,q3)*qd3+diff(dLdq5,qd1)*qdd1+diff(dLdq5,qd2)*qdd2+diff(dLdq5,qd3)*qdd3+diff(dLdq5,q4)*qd4+diff(dLdq5,q5)*qd5+diff(dLdq5,q6)*qd6+diff(dLdq5,qd4)*qdd4+diff(dLdq5,qd5)*qdd5+diff(dLdq5,qd6)*qdd6;
dLdq5 = diff(L,q5);
T5 = dLdq5dt - dLdq5;

% Ecuación4: T6 = d/dt(dL/qd6) - dL/q6
dLdq6 = diff(L,qd6);
dLdq6dt = diff(dLdq6,q1)*qd1+diff(dLdq6,q2)*qd2+diff(dLdq6,q3)*qd3+diff(dLdq6,qd1)*qdd1+diff(dLdq6,qd2)*qdd2+diff(dLdq6,qd3)*qdd3+diff(dLdq6,q4)*qd4+diff(dLdq6,q5)*qd5+diff(dLdq6,q6)*qd6+diff(dLdq6,qd4)*qdd4+diff(dLdq6,qd5)*qdd5+diff(dLdq6,qd6)*qdd6;
dLdq6 = diff(L,q6);
T6 = dLdq6dt - dLdq6;
%%
